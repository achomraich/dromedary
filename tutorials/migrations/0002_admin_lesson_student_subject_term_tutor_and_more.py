    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(choices=[('Python', 'Course description'), ('C++', 'Course description'), ('JS', 'Course description'), ('TypeScript', 'Course description'), ('Scala', 'Course description'), ('Ruby', 'Course description')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Term',
