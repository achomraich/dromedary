# Generated by Django 5.1.2 on 2024-12-07 16:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_request', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tutorials.lessonrequest')),
                ('subject_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tutorials.subject')),
                ('term_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tutorials.term')),
